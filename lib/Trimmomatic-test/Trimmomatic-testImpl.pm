package Trimmomatic-test::Trimmomatic-testImpl;
use strict;
...
sub new
{
    ...
    my $wsInstance = $cfg->val('Trimmomatic-test','workspace-url');
...
sub count_contigs
{
    ...
    my $ctx = $Trimmomatic-test::Trimmomatic-testServer::CallContext;
    my($return);
    #BEGIN count_contigs
