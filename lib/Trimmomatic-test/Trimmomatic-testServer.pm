package Trimmomatic-test::Trimmomatic-testServer;
...
our %async_run_methods = (
        'count_contigs_async' => 'Trimmomatic-test.count_contigs',
);

our %async_check_methods = (
        'count_contigs_check' => 'Trimmomatic-test.count_contigs',
);
...
sub call_method {
    ...
    my $ctx = Trimmomatic-test::Trimmomatic-testServerContext->new($self->{loggers}->{userlog},
...
{
    # Service Trimmomatic-test requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for Trimmomatic-test but no authentication header was passed");
	}
    ...
    my @result;
    {
        ...
        my $stderr = Trimmomatic-test::Trimmomatic-testServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service Trimmomatic-test.");
    }
...
package Trimmomatic-test::Trimmomatic-testServerContext;

use strict;

=head1 NAME

Trimmomatic-test::Trimmomatic-testServerContext
...
package Trimmomatic-test::Trimmomatic-testServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = Trimmomatic-test::Trimmomatic-testServer->new(
